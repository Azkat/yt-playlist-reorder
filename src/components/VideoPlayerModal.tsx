        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between pt-3 border-t">
            ...
            <a
              ...
              className="inline-flex items-center space-x-1 px-3 py-2 text-sm font-medium text-youtube-red hover:text-red-700 hover:bg-red-50 rounded-md transition-colors"
            >
